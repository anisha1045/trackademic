      ...
      <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 grid md:grid-cols-2 gap-8 w-full max-w-5xl transition">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5 justify-center">
          <h1 className="text-3xl font-bold text-gray-800">
            Welcome Back to <span className="text-indigo-600">Trackademic</span>
          </h1>
          <p className="text-sm text-gray-500 mb-2">Log in to continue</p>
          ...
          <button
            disabled={loading}
            type="submit"
            className="bg-indigo-600 text-white py-3 rounded-lg hover:bg-indigo-700 transition font-semibold flex items-center justify-center"
          >
            {loading ? (
              <svg
